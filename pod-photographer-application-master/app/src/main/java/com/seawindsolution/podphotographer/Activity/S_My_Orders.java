...
public class S_My_Orders extends RecyclerView.Adapter<S_My_Orders.ViewHolder> {
    ...
    public S_My_Orders(Context context, List<Booking_data> arrayList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tv_total_hr.setText(booking_data.getShootingHours());
        holder.tv_shooting_dates.setText(booking_data.getShootingDate());
        holder.tv_start_times.setText(booking_data.getShootingStartTime() + " o'clock");
        ...
        try {
            if (booking_data.getStatus().toString().equals("6")) {
                ...
                if (booking_data.getStatus().equals("1")) {
                    holder.tv_statu.setText("Placed");
                    holder.tv_statu.setTextColor(ContextCompat.getColor(context, R.color.placed));
                } else if (booking_data.getStatus().equals("2")) {
                    holder.tv_statu.setText("Confirmed");
                    holder.tv_statu.setTextColor(ContextCompat.getColor(context, R.color.confirm));
                } else if (booking_data.getStatus().equals("3")) {
                    holder.tv_statu.setText("Reschedule");
                    holder.tv_statu.setTextColor(ContextCompat.getColor(context, R.color.confirm));
                } else if (booking_data.getStatus().equals("4")) {
                    holder.tv_statu.setText("Cancel");
                    holder.tv_statu.setTextColor(ContextCompat.getColor(context, R.color.cancel));
                } else if (booking_data.getStatus().equals("5")) {
                    holder.tv_statu.setText("Shooting");
                    holder.tv_statu.setTextColor(ContextCompat.getColor(context, R.color.confirm));
                } else if (booking_data.getStatus().equals("6")) {
                    holder.tv_statu.setText("Completed");
                    holder.tv_statu.setTextColor(ContextCompat.getColor(context, R.color.confirm));
                }
        ...
        try {
            holder.crd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), S_upcoming.class);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        CardView crd;
        TextView tv_shooting_dates, tv_start_times, tv_total_hr, tv_statu;

        ViewHolder(View view) {
            super(view);

            crd = view.findViewById(R.id.cards);
            tv_total_hr = view.findViewById(R.id.tv_total_hr);
            tv_shooting_dates = view.findViewById(R.id.tv_shooting_dates);
            tv_start_times = view.findViewById(R.id.tv_start_times);
