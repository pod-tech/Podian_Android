...
public class Terms_and_condition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = ProgressDialog.show(Terms_and_condition.this, null, null, false, true);
        ...
        String slug = ("term-and-condition");
        ...
        Url.getWebService().getPage(slug).enqueue(new Callback<ResponseBody>() {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (responseObject.optBoolean("IsSuccess")) {
                            ...
                            Toast.makeText(Terms_and_condition.this, responseObject.optString("Message"), Toast.LENGTH_SHORT).show();
                        }
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(Terms_and_condition.this, R.string.error_pod, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(Terms_and_condition.this, R.string.error_pod,
