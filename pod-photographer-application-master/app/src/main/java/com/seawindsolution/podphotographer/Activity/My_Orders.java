...
public class My_Orders extends RecyclerView.Adapter<My_Orders.ViewHolder> {
    ...
    public My_Orders(Context context, List<Booking_data> arrayList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        //booking_data.setDisplayFlg("Yes");
