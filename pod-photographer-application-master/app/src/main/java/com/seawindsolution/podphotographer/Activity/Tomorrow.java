...
public class Tomorrow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = ProgressDialog.show(Tomorrow.this, null, null, false, true);
        progressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        progressDialog.setContentView(R.layout.layout_loading_dialog);
        progressDialog.setCancelable(false);
        progressDialog.dismiss();

        SessionManager session = new SessionManager(Tomorrow.this);
        ...
        LinearLayoutManager llm = new LinearLayoutManager(Tomorrow.this);
        recyclerView.setLayoutManager(llm);
        adapter = new S_My_Orders(Tomorrow.this, arrayList);
    ...
    private void getbookinglist(int id) {
        ...
        Url.getWebService().getOrderByPhotohrapherId(id).enqueue(new Callback<ResponseBody>() {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (responseObject != null) {
                        if (responseObject.optBoolean("IsSuccess")) {
                            ...
                            Toast.makeText(Tomorrow.this, responseObject.optString("Message"), Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(Tomorrow.this, R.string.error_pod, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(Tomorrow.this, R.string.error_pod, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                if (progressDialog.isShowing())
                    progressDialog.dismiss();
                Toast.makeText(Tomorrow.this, R.string.error_pod,
