...
public class Privacy_policy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = ProgressDialog.show(Privacy_policy.this, null, null, false, true);
        ...
        String slug = ("privacy-and-policy");
        ...
        Url.getWebService().getPage(slug).enqueue(new Callback<ResponseBody>() {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (responseObject.optBoolean("IsSuccess")) {
                            ...
                            Toast.makeText(Privacy_policy.this, responseObject.optString("Message"), Toast.LENGTH_SHORT).show();
                        }
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(Privacy_policy.this, R.string.error_pod, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(Privacy_policy.this, R.string.error_pod,
